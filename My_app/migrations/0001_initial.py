    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('module_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='My_app.module')),
            ],
        ),
        migrations.CreateModel(
            name='Attempt',
            fields=[
                ...
                ('task_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='My_app.task')),
